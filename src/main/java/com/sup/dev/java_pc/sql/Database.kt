...
object Database {
    ...
    fun init(login: String, pass: String, base: String, mysql_url: String, poolSize: Int, statisticCollector: (String, Long) -> Unit) {
        Database.statisticCollector = statisticCollector
